...
_*preséntate*_ con nombre, edad, y la mejor foto que tengas 📸

*Evita un ban, lee las reglas! 🥳*
        `,
        footer: 'Admin-TK te da la bienvenida',
        buttons: [
            { buttonId: 'verCanal', buttonText: { displayText: 'Ver Canal' }, type: 1, url: 'https://whatsapp.com/channel/0029VaS4zeE72WTyg5et571r' }
        ],
        headerType: 1
    };
}
