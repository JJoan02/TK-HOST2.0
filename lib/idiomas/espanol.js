...
```Soy el Admin-TK, te doy la bienvenida a @subject 🌟```
...
const smsBye = () => {
    return `
┊ @user salió del grupo
    `;
}

const smsSpromote = () => {
    return `
*@user 𝘼𝙃𝙊𝙍𝘼 𝙀𝙎 𝘼𝘿𝙈𝙄𝙉 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*
    `;
}

const smsSdemote = () => {
    return `
*@user 𝘿𝙀𝙅𝘼 𝘿𝙀 𝙎𝙀𝙍 𝘼𝘿𝙈𝙄𝙉 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*
    `;
}

const smsSdesc = () => {
    return `
*𝙇𝘼 𝙉𝙐𝙀𝙑𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙀𝙎:*\n\n@desc
    `;
}

const smsSsubject = () => {
    return `
*𝙀𝙇 𝙉𝙐𝙀𝙑𝙊 𝙉𝙊𝙈𝘽𝙍𝙀 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙀𝙎:*\n\n@subject
    `;
}
...
const eGataCoins = () => { return '🪙 AdminCoins' }
const eGataTickers = () => { return '🎫 Admin Tickers' } 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar Admin-TK`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar Admin-TK en Grupos`}
