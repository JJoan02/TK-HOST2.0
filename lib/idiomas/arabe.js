...
const smsLista1 = () => { return `🌟 معلومات ADMINBOT 🌟`}
...
//_allantilink.js
const smsTextoYT = () => { return '👻 ممتاز AdminBot-TK - WhatsApp '}
...
const eGataCoins = () => { return '🪙 TKCoins' }
const eGataTickers = () => { return '🎫 TK Tickets' } 
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام AdminBot`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام AdminBot في المجموعات`}
...
const smsJBInfo2 = () => { return `💖 *الوظيفة مستقرة ، إذا واجهت أي إزعاج ، فاتصل بالبريد: katashifukushima23@gmail.com*\n💝 *يمكنك تقديم تبرع طوعي عن طريق PayPal: ${global.paypal}*\n\n*شكرا جزيلا على الدعم ${global.packname}*`}
...
const smsContacto4 = () => { return 'جهة اتصال AdminBot الرسمية 👻'}
