  ...
  try { 
    ...
    *𓆩 𓃠 𓆪 ✧═══ ${vs} ═══✧ 𓆩 𓃠 𓆪*`.trim();
    ...
    listSections.push({
      ...
      rows: [
        { header: "𓃠 𝗔 𝗨 𝗗 𝗜 𝗢 (Opcion 1)", title: "", id: `${usedPrefix}yta ${yt_play[0].url}`, description: `${yt_play[0].title}\n` },
    ...
    // Descargar audio en máxima calidad
    const audioStream = ytdl(yt_play[0].url, { filter: 'audioonly', quality: 'highestaudio' });
    await conn.sendMessage(m.chat, { audio: audioStream, caption: `Audio en máxima calidad: ${yt_play[0].title}` });
