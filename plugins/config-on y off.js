...
description: `${1 + index}. ${descripcion[v]}`,
...
throw 'No tienes permisos para configurar esto fuera de un grupo';
}
} else if (!isAdmin) {
global.dfail('admin', m, conn);
throw 'No tienes permisos para configurar esto en el grupo';
}
