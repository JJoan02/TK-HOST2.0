...
let handler = async (m, { conn, text, command, usedPrefix }) => {
  ...
  conn.sendMessage(m.chat, {
        text: `✧¡Lograste cometer tu crimen con exito!, acabas de robar *${amountTaken} ❇️ coins* a @${randomUserId.split("@")[0]}\n\nSe suman *+${amountTaken} ❇️ coins* a ${senderName}.`,
  contextInfo: { 
  ...
  conn.reply(m.chat, `✧ No fuiste cuidadoso y te atraparon mientras cometias tu cirme, se restaron *-${amountSubtracted} ❇️ coins* a ${senderName}.`, m)
  break
  ...
  conn.sendMessage(m.chat, {
  text: `✧ Lograste cometer tu crimen con exito, pero te descubrieron y solo lograste tomar *${smallAmountTaken} ❇️ coins* de @${randomUserId.split("@")[0]}\n\nSe suman *+${smallAmountTaken} ❇️ coins* a ${senderName}.`,
  contextInfo: { 
  mentionedJid: [randomUserId],
  }
  }, { quoted: m })
